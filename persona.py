        ...
        if intent.is_cos_look:
            ...
            if feet_cropped:
                mode_lines.extend(
                    [
                        "【特写自拍 / 晒腿模式 / 脚部画外 / 不露脸】",
                        "像手机随手拍的一张日常照片，不要精修广告片，不要影棚柔光。",
                        "皮肤保留自然纹理、细小毛孔和轻微色差，不要磨皮、不要陶瓷光泽。",
                        "单人近距离俯拍：只拍少量腰腹/裙摆、大腿与膝部；双脚裁出画外，脸部也裁出画外。",
                        "保持参考图一的体态与肤色气质（本张不需要脸）。",
                        "双腿从髋到膝连续自然，左右各一；屈膝坐姿重心稳定，日常可维持；禁止膝盖顶脸。",
                        "腿部穿搭只用动作描述已选的光腿神器、白丝或黑丝；白丝/黑丝为不透的左右分离大腿袜，袜口/花纹/腿环按动作描述，主要看腿形。",
        ...
        if intent.is_cos_look:
            ...
            if feet_cropped:
                output_lines = [
                    ...
                    "4. 穿搭按动作描述选用光腿神器、白丝或黑丝；白丝/黑丝为不透的左右分离大腿袜，袜口/花纹/腿环按动作描述，主要看腿形。",
                    "5. 写实随手拍：可见皮肤纹理，不要磨皮塑料感；焦点在腿形。",
                ]
            else:
                output_lines = [
                    "【生成要求】",
