            ...
            if feet_cropped:
                mode_lines.extend(
                    [
                        ...
                        "双腿从髋到膝连续自然，左右各一，屈膝方向合理。",
                        "腿部穿搭只用动作描述已选的光腿神器、白丝或黑丝；白丝/黑丝为左右分离大腿袜，不是连裤袜。",
                        "严格执行动作描述构图；不补画脚部或鞋子。",
                ...
                mode_lines.extend(
                    [
                        "【特写自拍 / 晒腿模式】",
                        "单人下半身近景随手拍，重点在腿部线条、穿搭和居家细节，画面得体日常。",
                        "保持参考图一主角身份：发色、肤色、体态气质一致。",
                        "腿部穿搭只用动作描述已选的光腿神器、白丝或黑丝，不要自行换成其他袜类。",
                        "光腿神器自然通透；白丝/黑丝为轻薄中筒丝袜，袜口在大腿中段并完整包住脚部，不要连裤全包。不穿鞋。",
        ...
        if intent.is_group_photo:
            ...
            if feet_cropped:
                output_lines = [
                    ...
                    "3. 双腿结构自然，屈膝合理。",
                    "4. 穿搭按动作描述选用光腿神器、白丝或黑丝；白丝/黑丝为左右分离大腿袜，不是连裤袜。",
                    "5. 保持日常完整照片效果。",
                ]
            else:
                output_lines = [
                    ...
                    "4. 穿搭按动作描述选用光腿神器、白丝或黑丝；中筒丝袜完整包住脚部，不要连裤全包。",
                    "5. 肢体结构自然完整，保持日常随手拍效果。",
                ]
        else:
            output_lines = [
                "【生成要求】",
