        ...
        if intent.is_group_photo:
            ...
            mode_lines.extend(
                [
                    ...
                    "主姿势在「坐姿拍腿」与「跪坐拍腿」两种之间自然变化，不要次次同一姿势：",
                    "· 坐姿：窗边/床沿/地毯/单人椅，双腿前伸、斜侧、轻交叠或并拢放松；",
                    "· 跪坐：双膝跪地、臀坐小腿或脚跟，第一人称俯视拍自己的腿与脚背，依旧完全不露脸。",
                    "优先第一人称俯视视角（POV，低头看自己的腿），也可窗边坐姿、床沿、地毯或跪坐侧斜，构图始终不露脸。",
