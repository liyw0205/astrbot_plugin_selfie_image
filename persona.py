...
def anatomy_constraint_lines(*, style: str = "general") -> list[str]:
    ...
    if style == "legs":
        return [
            "单人限定：画面里只有主角一人。",
            "肢体完整自然：两条腿、两只脚，左右各一；可见手也左右各一。",
            "腿型微胖软肉、圆润有肉感，不要细杆腿，也不要大象腿猪腿；关节方向正常。",
            "脚部朝向自然，不要外翻或反折；脚趾形态正常。",
            "可见手与肩肘腕连续连接，自然放在腿侧或膝附近。",
        ]
    return [
        ...
        if intent.is_group_photo:
            ...
            if feet_cropped:
                mode_lines.extend(
                    [
                        "【特写自拍 / 晒腿模式 / 脚部画外】",
                        "单人近距离俯拍：只拍少量腰腹/裙摆、大腿与膝部，双脚裁出画外。",
                        "保持参考图一主角身份：发色、肤色、体态气质一致。",
                        "双腿从髋到膝连续自然，左右各一；大腿微胖软肉，不要细腿，也不要大象腿猪腿。",
                        "腿部穿搭只用动作描述已选的光腿神器、白丝或黑丝；白丝/黑丝为不透的左右分离大腿袜，主要看腿形，袜口可轻轻勒出浅压痕。",
                        "严格执行动作描述构图；不补画脚部或鞋子。",
                        "近距离俯视可有自然近大远小，画面得体日常。",
                    ]
                )
            else:
                mode_lines.extend(
                    [
                        "【特写自拍 / 晒腿模式】",
                        "单人下半身近景随手拍，重点在微胖软肉腿型、穿搭和居家细节，画面得体日常。",
                        "保持参考图一主角身份：发色、肤色、体态气质一致。",
                        "腿部穿搭只用动作描述已选的光腿神器、白丝或黑丝，不要自行换成其他袜类。",
                        "光腿神器自然通透；白丝/黑丝为不透的中筒丝袜，遮住肤色、主要看腿形，袜口在大腿中段并完整包住脚部；微胖大腿上袜口轻轻勒出浅压痕。不要超薄透视，不要连裤全包，不穿鞋。",
                        "只执行动作描述中的主姿势与构图；姿势日常合理。",
        ...
        if intent.is_group_photo:
            ...
            if feet_cropped:
                output_lines = [
                    "【生成要求】",
                    "1. 主角身份稳定，画面只有主角一人。",
                    "2. 近距离俯拍只露腰腹/裙摆到膝部，双脚裁出画外。",
                    "3. 大腿微胖软肉、屈膝合理；不要细杆腿，也不要大象腿猪腿。",
                    "4. 穿搭按动作描述选用光腿神器、白丝或黑丝；白丝/黑丝为不透的左右分离大腿袜，主要看腿形，袜口可轻轻勒出浅压痕。",
                    "5. 保持日常完整照片效果。",
                ]
            else:
                output_lines = [
                    ...
                    "3. 姿势跟动作描述，日常合理；不穿鞋，脚部自然完整。",
                    "4. 穿搭按动作描述选用光腿神器、白丝或黑丝；中筒丝袜不透、完整包住脚部，主要看腿形；微胖大腿上袜口轻轻勒出浅压痕，不要超薄透视，不要连裤全包。",
                    "5. 腿型微胖软肉、肢体自然完整；不要细杆腿，也不要大象腿猪腿。",
                ]
        else:
            output_lines = [
                "【生成要求】",
