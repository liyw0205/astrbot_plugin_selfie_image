    ...
    def build_selfie_prompt(
        ...
        if intent.is_group_photo:
            ...
            mode_lines.extend(
                [
                    "【特写自拍 / 晒腿模式】",
                    "成年角色下半身近景随手拍，构图重点在腿部线条、肤质、袜装/鞋面和居家衣料细节，画面得体、日常、柔和、舒服。",
                    "即使脸部不入镜，也必须保持参考图一的主角身份：发色、发型露出的部分发丝、肤色、体态、手部、穿搭气质和整体氛围都像同一个角色。",
                    "腿部肤质要干净细腻、自然通透，像「光腿神器」后的舒服观感：匀净柔光、无毛糙、无瑕疵斑点、不假白不油腻；可光腿，也可极薄肉色丝袜/过膝袜/长筒袜。",
                    "袜装、鞋子和衣服优先按用户本次要求；未指定时可在光腿、薄肉色丝袜、白/黑/灰长筒袜或过膝袜、小皮鞋、居家拖鞋等日常搭配中自然选择。",
                    "主姿势在多种日常拍腿姿势间变化，不要次次同一姿势，例如：",
                    "· 坐姿拍腿：窗边/床沿/地毯/椅上，腿前伸、斜侧、轻交叠；",
                    "· 跪坐/跪立拍腿：双膝跪地，臀坐小腿或略抬上身，俯视腿脚，不露脸；",
                    "· 侧躺曲腿：侧卧床/地毯，一腿微屈一腿略伸，腰下往脚方向近景；",
                    "· 抱膝坐：坐姿收膝，手抱膝或扶小腿；",
                    "· 翘二郎腿坐：一腿架在另一腿上，强调小腿外侧与脚踝；",
                    "· 站立俯视膝下：只拍腰下到脚，禁止正脸与全身立绘；",
                    "· 窗台蹬坐：稳坐窗台/矮台，脚踩边缘或垂下，得体安全；",
                    "· 单膝跪地整理：一膝跪一脚踩地，手整理袜口或鞋边，带一点动作。",
                    "优先第一人称俯视或下半身近景，构图始终不露脸。",
                    "画面重点：裙摆/裤脚、膝盖、小腿、脚踝、鞋袜、衣料垂落、地毯/床单纹理、手部轻扶膝盖或轻扯裙边等生活化细节。",
                    "脸部保持在画面外，构图集中在下半身、腿部和周围居家环境。",
                    "手部可自然整理裙摆、衣角、袜口，或轻扶膝盖；动作含蓄放松。",
