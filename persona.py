    ...
    def build_selfie_prompt(
            ...
            if intent.is_group_photo:
                ...
                reference_lines.extend(
                    [
                        ...
                        "如果额外参考图里的人用手机、手、物品、口罩、面具、贴纸、头发、阴影、马赛克或其他东西遮挡脸部，默认不要复制这些遮挡物。",
                        "除非用户明确要求遮脸或挡脸，否则主角脸部必须清晰露出，使用参考图一的脸和表情关系。",
                    ]
                    if has_reference_image
                    else [
                        "额外参考图用于构图、衣服、姿势、场景或光线氛围；主角仍符合角色名称和人设。",
                        "如果额外参考图里的人用东西挡脸，默认不要复制挡脸物；除非用户明确要求遮脸，否则主角脸部清晰露出。",
                    ]
                )
        ...
        if intent.is_group_photo:
            ...
            mode_lines.extend(
                [
                    ...
                    "脚背、脚踝和腿部皮肤要干净细腻；避免明显青筋、血管、突兀肌腱、脏污脚面、皱皮、夸张骨节、畸形脚趾或不自然脚踝。",
            ...
            mode_lines.extend(
                [
                    ...
                    "额外参考图里的遮脸物、挡脸动作或遮挡关系不作为服装和姿势的一部分，除非用户明确要求保留。",
                ]
            )
            ...
            mode_lines.extend(
                [
                    ...
                    "额外参考图里的遮脸物、挡脸动作或遮挡关系不属于穿搭内容，除非用户明确要求保留。",
                ]
            )
            ...
            mode_lines.extend(
                [
                    ...
                    "额外参考图里的遮脸物、挡脸动作或遮挡关系不属于姿势目标，除非用户明确要求保留。",
                ]
            )
        else:
            mode_lines.extend(
        ...
        if intent.is_group_photo:
            ...
            output_lines = [
                ...
                "4. 人体结构自然完整，腿部比例、坐姿重心、手部互动、衣料和光影关系可信；不要青筋、明显血管、突兀肌腱、脏污脚面或畸形脚踝脚趾。",
            ...
            output_lines = [
                ...
                "3. 除非用户明确要求遮脸，否则主角脸部无遮挡、清晰可见，脸和五官保持参考图一或角色设定。",
