            ...
            if feet_cropped:
                mode_lines.extend(
                    [
                        ...
                        "腿部穿搭只用动作描述已选的光腿神器、白丝或黑丝；白丝/黑丝为左右分离大腿袜，袜口可轻轻勒出浅压痕。",
                        "严格执行动作描述构图；不补画脚部或鞋子。",
                ...
                mode_lines.extend(
                    [
                        ...
                        "光腿神器自然通透；白丝/黑丝为轻薄中筒丝袜，袜口在大腿中段并完整包住脚部；微胖大腿上袜口轻轻勒出浅压痕，反差自然。不要连裤全包，不穿鞋。",
        ...
        if intent.is_group_photo:
            ...
            if feet_cropped:
                output_lines = [
                    ...
                    "4. 穿搭按动作描述选用光腿神器、白丝或黑丝；白丝/黑丝为左右分离大腿袜，袜口可轻轻勒出浅压痕。",
                    "5. 保持日常完整照片效果。",
                ]
            else:
                output_lines = [
                    ...
                    "4. 穿搭按动作描述选用光腿神器、白丝或黑丝；中筒丝袜完整包住脚部；微胖大腿上袜口轻轻勒出浅压痕，不要连裤全包。",
