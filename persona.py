    ...
    def build_selfie_prompt(
        ...
        if intent.is_group_photo:
            ...
            mode_lines.extend(
                [
                    ...
                    "光腿神器要自然通透像干净裸腿；白丝/黑丝必须是轻薄半透明中筒丝袜，袜口到大腿中段，包住脚踝与整只脚到脚趾，大腿根以上露肤；禁止连裤/全包裤袜，也禁止露趾露跟或半截未包脚。赤足无鞋。",
        ...
        if intent.is_group_photo:
            ...
            output_lines = [
                ...
                "4. 腿部穿搭严格采用动作描述中选定的光腿神器、白丝或黑丝；白丝/黑丝为到大腿的中筒半透丝袜且包住整脚到脚趾，不要连裤全包、不要露趾半截；不要任何鞋子。",
