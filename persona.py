            ...
            if feet_cropped:
                mode_lines.extend(
                    [
                        ...
                        "双腿从髋到膝连续自然，左右各一。",
                        "腿部穿搭只用动作描述已选的光腿神器、白丝或黑丝；白丝/黑丝为不透的左右分离大腿袜，主要看腿形，袜口可带浅压痕。",
                        "严格执行动作描述构图；不补画脚部或鞋子。",
                ...
                mode_lines.extend(
                    [
                        ...
                        "光腿神器自然通透；白丝/黑丝为不透的中筒丝袜，遮住肤色、主要看腿形，袜口在大腿中段并完整包住脚部，可带浅压痕。不要超薄透视，不要连裤全包，不穿鞋。",
        ...
        if intent.is_group_photo:
            ...
            if feet_cropped:
                output_lines = [
                    ...
                    "3. 双腿结构自然、屈膝合理。",
                    "4. 穿搭按动作描述选用光腿神器、白丝或黑丝；白丝/黑丝为不透的左右分离大腿袜，主要看腿形，袜口可带浅压痕。",
                    "5. 保持日常完整照片效果。",
                ]
            else:
                output_lines = [
                    ...
                    "4. 穿搭按动作描述选用光腿神器、白丝或黑丝；中筒丝袜不透、完整包住脚部，主要看腿形，袜口可带浅压痕；不要超薄透视，不要连裤全包。",
                    "5. 腿部结构自然完整。",
                ]
        else:
            output_lines = [
