...
def default_video_preset_seed() -> Dict[str, Dict[str, Any]]:
    ...
    return {
        ...
        "兰花指卡点舞": {
            "prompt": (
                "生成20秒9:16竖屏、带原生同步音轨的单人舞蹈视频；人物从第0秒立即开始运动，禁止静止展示服装。"
        ...
        "复仇摇": {
            "prompt": (
                "生成16秒9:16竖屏、带原生同步音轨的高清真人舞蹈视频；人物从第0秒开始跟拍舞动，人物始终居中，禁止静止展示服装。"
        ...
        "复仇摇2": {
            "prompt": (
                "生成16秒9:16竖屏、带原生同步音轨的高清真人舞蹈视频；镜头全程跟随女孩跳‘复仇摇’，人物始终居中，"
        ...
        "鱼块摇": {
            "prompt": (
                "生成13.6秒9:16竖屏高清真人舞蹈视频，带原生同步音轨；人物从第0秒开始跟拍舞动，始终居中，禁止静止展示服装。"
                ...
                "禁止古风乐器独奏和古风乐器音效；所有点指、绕腕、敲击、下压、转花手、摆胯、下捶和定格必须卡在鼓点重拍上。"
                "必须输出可听见的BGM，禁止静音、禁止唱歌、禁止口型说话。"
                "自然光影、真实肤质、动态流畅；避免动作延迟、机械循环、手指粘连、手腕反折、肢体穿模、额外手臂、手指畸形、"
                "头发遮脸、服装漂移、背景闪烁和镜头剧烈抖动。"
            ),
            "description": "鱼块摇魔性带感13.6秒卡点舞，Blow DJ鼓点，动作干脆利落",
            # Video request metadata is integer seconds; the prompt retains the requested 13.6s timing.
            "duration": 13,
        },
    }
