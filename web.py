...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .model-row.with-provider-download { grid-template-columns: minmax(0, 1fr) minmax(120px, 150px) minmax(120px, 160px) auto; }
    .model-download-proxy { min-width: 120px; padding: 5px 8px; font-size: 12px; }
    @media (max-width: 900px) {
      .model-row.with-provider-download { grid-template-columns: 1fr; }
    }
