...
LEGWEAR_PROMPTS = {
    ...
    "白丝": (
        "本次腿部穿搭：白丝。"
        "纯白轻薄中筒丝袜，袜口在大腿中段，完整包住小腿与脚部，大腿根以上露肤；"
        "大腿微胖软肉，袜口轻轻勒出浅压痕和一点软肉鼓起，反差自然；不要涂色感或连裤全包，不要细腿，也不要大象腿猪腿。"
    ),
    "黑丝": (
        "本次腿部穿搭：黑丝。"
        "纯黑轻薄中筒丝袜，袜口在大腿中段，完整包住小腿与脚部，大腿根以上露肤；"
        "大腿微胖软肉，袜口轻轻勒出浅压痕和一点软肉鼓起，反差自然；不要涂色感或连裤全包，不要细腿，也不要大象腿猪腿。"
    ),
}
        ...
        *,
        ...
        if feet_cropped:
            if legwear == "光腿神器":
                ...
                legwear_rule = (
                    f"本次腿部穿搭：{legwear}。{color}轻薄左右分离大腿袜，袜口在大腿上段；"
                    "大腿微胖软肉，袜口轻轻勒出浅压痕和一点软肉鼓起；不是连裤袜。袜身向画外延伸，不展示脚部。"
                )
        base = (
            "看看腿。"
