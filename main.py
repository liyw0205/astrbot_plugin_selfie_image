...
LEGWEAR_PROMPTS = {
    "光腿神器": (
        "本次腿部穿搭：光腿神器。"
        "自然肤色、轻薄通透的光腿效果；大腿偏微胖软肉、圆润有肉感，不要细杆腿，也不要大象腿猪腿。"
    ),
    "白丝": (
        "本次腿部穿搭：白丝。"
        "纯白不透的中筒丝袜，遮住肤色，主要看腿形轮廓与微胖软肉体积；袜口在大腿中段，完整包住小腿与脚部，大腿根以上露肤；"
        "袜口轻轻勒出浅压痕和一点软肉鼓起，反差自然；不要超薄透视、不要透到能清楚看见皮肤纹理，不要涂色感或连裤全包，不要细腿，也不要大象腿猪腿。"
    ),
    "黑丝": (
        "本次腿部穿搭：黑丝。"
        "纯黑不透的中筒丝袜，遮住肤色，主要看腿形轮廓与微胖软肉体积；袜口在大腿中段，完整包住小腿与脚部，大腿根以上露肤；"
        "袜口轻轻勒出浅压痕和一点软肉鼓起，反差自然；不要超薄透视、不要透到能清楚看见皮肤纹理，不要涂色感或连裤全包，不要细腿，也不要大象腿猪腿。"
    ),
}
    ...
    def _build_leg_focus_action(
        ...
        *,
        ...
        if feet_cropped:
            ...
            anatomy_rules = (
                "单人限定：只有主角一人。两条大腿与两个膝部左右各一，连接自然。"
                "大腿微胖软肉、圆润有肉感，不要细杆腿，也不要大象腿猪腿；屈膝坐姿合理，近距离俯视可有近大远小。"
            )
        else:
            hard_crop = (
        ...
        if feet_cropped:
            if legwear == "光腿神器":
                legwear_rule = "本次腿部穿搭：光腿神器。大腿微胖软肉、通透干净，不要细腿，也不要大象腿猪腿。"
            else:
                color = "纯白" if legwear == "白丝" else "纯黑"
                legwear_rule = (
                    f"本次腿部穿搭：{legwear}。{color}不透的左右分离大腿袜，主要看腿形与软肉体积，袜口在大腿上段；"
                    "袜口轻轻勒出浅压痕和一点软肉鼓起；不要超薄透视。不是连裤袜。袜身向画外延伸，不展示脚部。"
                )
        base = (
            "看看腿。"
            ...
            "姿势日常合理、重心稳定、关节自然，不要僵硬拧腿或夸张体位。"
            "腿型微胖软肉、圆润有肉感，第一人称俯视可有近大远小；不要细杆腿，也不要大象腿猪腿。"
