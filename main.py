...
COS_LOOK_SETS: List[Dict[str, str]] = [
    {"id": "roxy_cream", "title": "洛琪希·奶油睡衣", "prompt": "严格换装为洛琪希奶油色居家睡衣两件套：米白奶油色无袖睡衣上衣，柔软微皱棉质，领口与肩线细荷叶边抽褶；胸前白色缎带大蝴蝶结与长飘带；同色宽松睡衣短裤；浅薰衣草紫超长发双麻花辫垂在胸前；对镜坐在木地板地毯上；禁止蓝色旅行法师外套、宽檐帽、法杖。"},
    ...
    {"id": "rem_blue_lolita", "title": "蕾姆·蓝白女仆洛丽塔", "prompt": "严格换装为蕾姆蓝白女仆洛丽塔：浅蓝短发，侧边白色发饰；蓝色连衣裙配白色蕾丝围裙、白色蕾丝领口和袖口，腰后大白蝴蝶结；白色多层裙摆，蓝色裙身，黑色或深蓝色短靴；清爽蓝白配色，室内柔光对镜自拍，不要圣诞装、不要体操服、不要把服装画成普通校服。"},
    {"id": "lusha_white_gold", "title": "露莎公主·白金礼服", "prompt": "严格换装为露莎公主风白金礼服：白色收腰上身，金色滚边和金色腰封，白色蓬松短裙与轻薄白色披肩；银白或浅金长直发，银色宝石头冠，少量紫色宝石点缀；白、金、银为主色，室内柔光对镜全身，华丽但结构清楚，不要普通白裙。"},
   {"id": "elsa_ice_cape", "title": "艾莎·冰蓝披风礼服", "prompt": "严格换装为艾莎冰雪公主礼服：冰蓝色收腰长裙，裙面有细小雪花纹理和轻微亮片；半透明冰蓝长披风从肩部垂下并拖到身后；冰蓝长发侧编发，简洁雪花发饰；冷白与冰蓝配色，礼服轮廓完整，室内柔光对镜自拍，不要现代婚纱、不要厚重大衣。"},
    {"id": "miku_formula_blue", "title": "初音未来·蓝白公式服", "prompt": "严格换装为初音未来经典蓝白公式服：青绿色双马尾，黑色耳机；青绿色领带与白色短袖上衣，深色衣领和袖口细节，黑灰高腰百褶短裙，腿侧有青绿色装饰；黑色过膝袜和简洁黑鞋；未来感但服装结构清晰，室内柔光对镜自拍，不要把它画成普通JK制服。"},
    {"id": "sakura_pink_magic", "title": "木之本樱·粉白魔法裙", "prompt": "严格换装为木之本樱经典粉白魔法少女服：粉色连衣裙，白色领口和白色袖口，藏蓝色短裙层或裙摆内层，胸前与头顶配大蝴蝶结；白色长袜，棕色短发，头戴粉色发饰；粉、白、藏蓝三色清楚分层，裙摆有适度蓬度，室内柔光对镜自拍，不要改成普通洛丽塔或校服。"},
    {"id": "shinobu_butterfly", "title": "蝴蝶忍·蝶纹羽织", "prompt": "严格换装为蝴蝶忍经典鬼杀队造型：深紫黑色长发在脑后挽起，佩戴浅紫蝴蝶发饰；深色立领制服上衣配同色百褶裤裙，外披白色渐变浅紫的宽袖羽织，衣摆和袖口带清晰黑色蝶翼纹路；小腿缠白色绑腿，脚穿简洁草履；对镜全身自拍，不要护士服、不要女仆装、不要武器遮挡服装。"},
    {"id": "mitsuri_love", "title": "甘露寺蜜璃·恋柱羽织", "prompt": "严格换装为甘露寺蜜璃经典恋柱造型：樱粉色长发末端渐变草绿，编成三股粗麻花辫；白色短羽织敞开穿着，内搭深色鬼杀队制服上衣和深色百褶短裙；绿色条纹过膝袜配白色草履；粉、白、深色和草绿配色清楚，室内柔光对镜全身，不要女仆装、不要夸张武器。"},
    {"id": "tracen_academy", "title": "赛马娘·特雷森学院制服", "prompt": "严格换装为赛马娘特雷森学院制服：深蓝紫色短款西装外套，白衬衫和青绿色领结，金色滚边与双排金扣；白色高腰百褶短裙带蓝紫色裙边；棕色长发配自然马耳和小型丝带发饰，保留单条自然马尾；白色及膝袜配棕色乐福鞋；清爽学院风，对镜全身自拍，不要普通水手服、不要赛场背景。"},
    {"id": "yao_cinnamoroll", "title": "瑶·大耳狗之梦", "prompt": "严格换装为瑶的大耳狗联动甜美套装：浅蓝白渐变长发，头戴白色大耳朵软帽和浅蓝蝴蝶结；白色泡泡袖短上衣配浅蓝滚边，胸前大蝴蝶结；浅蓝白多层蓬蓬短裙，裙摆有少量云朵与星星装饰；白色过膝袜配浅蓝鞋；整体白与浅蓝配色，柔软清爽，对镜全身自拍，不要鹿角、不要复杂铠甲。"},
    {"id": "barbara_idol", "title": "芭芭拉·蓝白祈礼服", "prompt": "严格换装为芭芭拉经典蓝白祈礼偶像服：浅金色双马尾卷发，头戴白色牧师帽式发饰并配蓝色蝴蝶结；白色无袖收腰上衣，蓝色领口、金色细滚边和胸前蓝色蝴蝶结；白色百褶短裙配蓝色裙摆和白色小围裙层；白色长袜与深色低跟鞋；蓝白金配色清楚，室内柔光对镜全身，不要泳装、不要法杖和水特效。"},
]
