...
class SelfieImagePlugin(Star):
    ...
    def _build_leg_focus_action(
        ...
        *,
        ...
        pose_variants = {
            "sit": [
                (
                    ...
                    "可光腿或极薄肉色丝袜/过膝袜/堆堆袜，坐在米白色毛绒地毯上，窗边柔和阳光；"
                    "双手自然放在身侧或腿上，不要去摸鞋、袜口或鞋带。"
                ),
                (
                    "第一人称低头随手拍，坐在床沿，双腿向前自然伸展后轻微斜放，"
                    "腿部皮肤干净细腻（光腿神器质感：通透匀净、不假白不油腻），室内暖光和浅色床单；"
                    "手可轻搭膝盖，禁止整理袜口、摸鞋边或系鞋带。"
                ),
                (
                    "窗边单人椅坐姿，双腿并拢后向一侧自然倾斜，裙摆垂落，腿部线条流畅、肤质细腻柔光，"
                    "小皮鞋或居家拖鞋材质清楚，地板柔和反光，日常穿搭记录感；手不碰鞋袜。"
                ),
            ],
            "kneel": [
                (
                    ...
                    "腿部光洁细腻像光腿神器——自然通透、匀净柔光，可光腿或过膝袜/堆堆袜/极薄肉色丝袜；"
                    "双手自然放在大腿上，不要扶鞋、摸袜或系鞋带。"
                ),
                (
            ...
            "side_lie": [
                ...
                (
                    ...
                    "不露脸，小腿脚踝线条舒服，光腿或薄丝，居家暖调，浅景深；手不碰鞋袜。"
                ),
            ],
            "hug_knee": [
                (
                ...
                (
                    ...
                    "肤质通透匀净，手只在膝盖附近，禁止去脚面理袜或系鞋带，窗边或床边暖光。"
                ),
            ],
            "cross_leg": [
                (
                    "翘二郎腿坐：坐在椅边或床沿，一条腿架在另一条腿上，强调小腿外侧与脚踝，"
                    "第一人称略俯视下半身，不露脸，腿部细腻柔光如光腿神器，可光腿或过膝袜/堆堆袜/薄肉色丝袜，"
                    "鞋面可入镜但手不要碰鞋；穿搭记录感。"
                ),
                (
                    "沙发上跷腿坐：一腿搭在另一腿膝上，裙摆/裤脚自然，镜头拍膝下到脚，完全不露脸，"
                    "腿线干净舒服，室内漫射光，日系居家；双手远离鞋袜。"
                ),
            ],
            "stand_topdown": [
                (
                    ...
                    "腿部肤质细腻通透（光腿神器），光腿或薄丝；画面里尽量不出现手，或手远离脚面。"
                ),
                (
                    "站立近景膝下：第一人称低头只看见自己的小腿与脚面，裁切在腰线以下，脸部完全出画，"
                    "肤质匀净柔光，鞋袜或光脚都干净，木地板/地毯纹理清楚；禁止手伸进画面摸鞋。"
                ),
            ],
            "windowsill": [
                (
                    ...
                    "得体日常，稳坐感；手扶台沿即可，不要摸鞋带或理袜。"
                ),
                (
                    "窗边矮台坐拍腿：臀坐台沿，一脚踩台、一脚垂下，第一人称俯视腿脚，脸部出画，"
                    "薄丝或光腿，肤质通透舒服，居家窗光；双手不碰鞋袜。"
                ),
            ],
            "kneel_up": [
                (
                    ...
                    "裙摆/裤脚垂落，地毯背景；手自然垂放或轻放大腿，禁止整理鞋袜。"
                ),
                (
                    "高跪姿侧斜：跪姿重心略抬，身体微侧，低头拍小腿脚踝，不露脸，"
                    "肤质细腻匀净，居家暖光，日常随手拍；无摸鞋、无系鞋带动作。"
                ),
            ],
        }
        pose_labels = {
        ...
        sock_rules = (
            "袜装偏好（未指定时）：优先过膝袜、堆堆袜（中筒自然松松堆在脚踝上方）、长筒袜；"
            "也可光腿或极薄肉色丝袜。"
            "避免只盖到脚踝、看起来又短又紧的短袜；用户明确要求短袜/光腿/黑丝等时以用户为准。"
        )
        base = (
            "看看腿。"
    ...
    def _build_group_selfie_action(self, extra_request: str = "", has_refs: bool = False) -> str:
        base = (
            "合影 / 合照 / 同框。AI 自己必须作为画面主角之一，与用户指定或提供的对象自然同框合影，保持 AI 当前写实形象一致。"
        ...
        if has_refs:
            base += " 用户提供或艾特对象的图片是合影角色来源（真人保外观倾向；二次元只取线索并转写实；非人物按风格拟人成写实人物）。"
        else:
            base += " 没有合影对象参考图时，按文字要求生成自然同框写实对象。"
        extra = re.sub(r"\s+", " ", str(extra_request or "")).strip(" 。")
        if extra:
            base += f" 用户补充要求：{extra}。"
        return base
