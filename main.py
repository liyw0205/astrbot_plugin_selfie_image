...
LEGWEAR_PROMPTS = {
    "光腿神器": (
        "本次腿部穿搭：光腿神器。"
        "自然肤色、带轻微皮肤纹理的光腿效果，主要看腿形；不要陶瓷磨皮；不展示脚部与脚趾。"
    ),
    "白丝": (
        "本次腿部穿搭：白丝。"
        "不透的左右分离白色大腿袜，可见织物纹理，哑光或轻微丝光，不要塑料反光；主要看腿形；袜口在大腿中上段；"
        "袜身向膝下延伸后出画，不展示脚部；不要超薄透视，不要连裤全包。"
    ),
    "黑丝": (
        "本次腿部穿搭：黑丝。"
        "不透的左右分离黑色大腿袜，可见织物纹理，哑光或轻微丝光，不要塑料反光；主要看腿形；袜口在大腿中上段；"
        "袜身向膝下延伸后出画，不展示脚部；不要超薄透视，不要连裤全包。"
    ),
}

# Random stocking finishes. 平口更易出袜口浅痕；花纹/镂空/丝带/腿环可自由组合。
STOCKING_FINISH_CHOICES: List[Tuple[str, int]] = [
    (
        "袜口用平整罗纹平口，贴合大腿并轻轻勒出一圈浅痕，素色袜身。",
        3,
    ),
    (
        "袜口清晰卷边，素色袜身。",
    ...
    (
        "大腿中段加一条腿环（可配金属小扣或蕾丝边），袜口用平整平口轻轻勒出浅痕。",
        2,
    ),
    (
        "大腿中段加腿环，袜口丝带结，袜身可有小镂空或细纹。",
        2,
    ),
]
...
# Prompts emphasize concrete garment structure so gens stay closer to reference.
COS_LOOK_SETS: List[Dict[str, str]] = [
    {
        "id": "gongsunli_teal",
        "title": "公孙离·青金短裙",
        "prompt": (
            "严格换装为王者荣耀公孙离默认舞姬短装，服装结构必须齐全："
            "孔雀青绿/青色抹胸短裙，深V，胸口到腰金色祥云刺绣；"
            "短裙摆外扩微侧开，内侧多层白色荷叶边裙撑外露；"
            "肩臂披半透明冰蓝薄纱披肩；腰金链+多条红色流苏；"
            "颈间金项链垂红珠与绿长流苏；不要长袍全身甲，居家自拍，日常得体。"
        ),
    },
    {
        "id": "gongsunli_ink",
        "title": "公孙离·墨染江湖",
        "prompt": (
            "严格换装为王者荣耀公孙离皮肤墨染江湖，不要青绿金绣那套默认舞姬皮："
            "墨黑长发半挽偏髻，白梅与墨竹细簪；宣纸白抹胸短襦贴合腰线，外罩半透墨色广袖薄纱，袍襟敞开；"
            "下装墨色高开叉长裙，裙面泼墨竹叶与飞白笔触；腰系墨绦配白玉佩；"
            "对镜全身，裙衩与坐立姿态自然带出腿部线条；不要铠甲、不要油彩大花脸。"
        ),
    },
    {
        "id": "elysia_pink",
        ...
        "prompt": (
            "严格换装为爱莉希雅粉白奇幻套："
            "粉色短波波假发、尖精灵耳、白色发饰；"
            "白底紧身短裙套装，紫色缎面嵌板，金色浮雕花纹，胸前大紫金吊坠；"
            "侧腰与裙摆半透明全息/镭射布拼接，不对称短裙飘带；"
            "紫色金边护臂；华丽精灵公主风，不要普通连衣裙，室内柔光，日常得体。"
        ),
    },
    {
        "id": "mansui_xianxia",
        "title": "满穗·冰蓝仙侠",
        "prompt": (
            "严格换装为冰蓝仙侠广袖袍，按居家跪坐对镜来拍："
            "外层极透冰蓝广袖薄纱长袍，蓝金花鸟刺绣与垂坠流苏，袍襟敞开自然垂在身侧；"
            "内层米白襦裙，侧摆高开衩；腰间蓝色细丝绦配金色腰扣与长蓝飘带；"
            "深色长发自然披肩，小白花发饰；跪坐白色绒毯或地毯，裙衩随坐姿自然分开，"
            "低机位对镜带出腿部线条；不要现代常服，不要把袍子裹死。"
        ),
    },
    {
        "id": "sora_white",
        ...
        "prompt": (
            "严格换装为春日野穹居家白裙："
            "白色轻薄荷叶边抹胸超短睡裙，胸口正中黑色丝带大蝴蝶结；"
            "肩胸裙摆层层白荷叶边，裙长约大腿根，可半透；"
            "长直铂金假发及腰，左右各一个黑色大丝带发结；"
            "日系软萌居家，不要校服JK，室内木地板柔光，日常得体。"
        ),
    },
    {
        "id": "roxy_cream",
        "title": "洛琪希·奶油睡衣",
        "prompt": (
            "严格换装为洛琪希奶油色居家睡衣两件套（不是蓝袍法师装）："
            "米白/奶油色无袖睡衣上衣，柔软微皱棉质，领口与肩线细荷叶边抽褶；"
            "胸前正中白色缎带大蝴蝶结，长飘带下垂；同色宽松睡衣短裤，松紧腰，长度大腿中上；"
            "浅薰衣草紫/淡蓝紫超长发粗双麻花辫垂在胸前，可轻握一缕辫子；"
            "对镜坐在木地板地毯上；禁止蓝色旅行法师外套、禁止宽檐帽、禁止法杖。"
        ),
    },
    {
        "id": "hanfu_peach",
        ...
        "prompt": (
            "严格换装为桃粉齐胸汉服："
            "无肩带齐胸抹胸高腰，桃粉半透多层长裙飘逸，细微花卉刺绣；"
            "高腰翠绿宽丝带长飘带；黑发高髻配粉色牡丹与金簪；"
            "细金项链与长吊坠耳环；古风优雅，不要现代礼服，日常得体。"
        ),
    },
    {
        "id": "lusha_princess",
        ...
        "prompt": (
            "严格换装为白金二次元公主装："
            "超长直白发及腰，银色镶紫宝石头冠+黑色猫耳发饰；"
            "金色金属项圈，白色交叉绑带胸衣，白荷叶边抹胸金包边；"
            "金色腰封流苏链，白色短裙，半透明白披肩；金色宽手镯；"
            "华丽 galgame 公主感，不要普通白裙，室内柔光，日常得体。"
        ),
    },
    {
        "id": "sagiri_pinkbow",
        ...
        "prompt": (
            "严格换装为和泉纱雾居家风："
            "银色长直发，头顶左右亮粉蝴蝶结发夹，侧发再夹粉结；"
            "白色短袖露脐短T，袖口绿色滚边，正面大号粉色汉字印花；"
            "深蓝超短牛仔热裤；白色过膝长筒袜，袜口两道白细横条；"
            "二次元宅家自拍，不要校服，日常得体。"
        ),
    },
    {
        "id": "xishi_shiyujiangnan",
        "title": "西施·诗雨江南",
        "prompt": (
            "严格换装为王者荣耀西施皮肤诗雨江南，不要普通洛丽塔："
            "粉橙江南纱裙：内层浅色低胸缎面裹胸，中层珊瑚橙宽腰带层带金色牡丹刺绣；"
            "外层半透明粉纱广袖披帛，浅粉过渡珊瑚橙，轻纱飞扬；"
            "下裙珊瑚橙缎面长裙，金粉花卉刺绣，裙摆层叠轻开；"
            "颈间红珠链垂至胸口，可带花形垂饰；黑长发可配绢花发饰；"
            "整体粉、珊瑚橙、金、白，江南诗雨水色，日常得体。"
        ),
    },
    {
        "id": "mint_sheer_hanfu",
        "title": "薄荷粉纱汉服",
        "prompt": (
            "严格换装为薄荷绿与淡粉渐变半透明汉服广袖外袍："
            "超薄轻纱，晕染花卉，大领口可微露肩；内衬浅粉；"
            "深棕长发高髻，空气刘海，右侧白色绢花，左侧长辫垂腰；"
            "细银链小吊坠；清冷杂役弟子感，日常得体，不要铠甲。"
        ),
    },
    {
        "id": "shaosiyuan_red",
        ...
        "prompt": (
            "严格换装为王者荣耀少司缘："
            "薄荷绿长波浪发，齐刘海；头顶两侧大型红色兔耳/飘带发饰，黑尖刺点缀与红流苏；"
            "黑露肩短内搭，外层鲜红高开叉长袍式裙，右侧高叉露黑安全裤与腿；"
            "胸前大红宝石领饰配白大蝴蝶结飘带；右臂红长袖披风袖，左肩黑护肩；"
            "红黑配色华丽，居家或墙边站姿，日常得体。"
        ),
    },
    {
        "id": "jeanne_white_lace",
        "title": "圣女贞德·白蕾丝",
        "prompt": (
            "严格换装为碧蓝航线圣女贞德白蕾丝圣女装："
            "金色短直波波头，白色大花蕾丝发饰+蓝流苏；"
            "白半透薄纱长手套肘上蕾丝边；白色多层蕾丝颈饰+金细项链绿宝石吊坠；"
            "白色露肩/抹胸连体短礼服，全身白蕾丝立体花朵贴花，腰部荷叶蓬松，高开叉；"
            "左腕金手链绿宝石；纯白主色少量金与绿点缀，不要铠甲版贞德，日常得体。"
        ),
    },
    {
        "id": "mai_white_red",
        "title": "不知火舞·白红结构",
        "prompt": (
            "严格换装为白红黑结构化短装（不知火舞现代cos向）："
            "露肩白色紧身胸衣，黑滚边深V，左侧胸口白色立体大花，少量金扣；"
            "分离式宽袖：白外层+内衬亮玫红/粉，袖身蓬松半透；"
            "腰部多层黑皮革绑带金三角扣与垂吊黑带；下身红布侧开飘带+白内层；"
            "红白黑游戏幻想风，不要普通旗袍一笔带过，日常得体。"
        ),
    },
    {
        "id": "cartethyia_gold",
        ...
        "prompt": (
            "严格换装为鸣潮卡提希娅："
            "金色大波浪长发及腰，蓝羽/叶状发夹；前额白色枝状鹿角金属头饰蓝尖端；"
            "黑高领紧身胸衣金滚边，胸口与侧腰镂空；金细链圆吊坠蝴蝶结；"
            "白色长开襟披肩前襟垂至膝，淡蓝叶脉刺绣；半透黑薄纱披风；"
            "黑白金蓝配色，精致奇幻，日常得体。"
        ),
    },
    {
        ...
        "prompt": (
            "严格换装为鸣潮菲比，对镜全身："
            "金色长发齐刘海，两侧高双马尾波浪垂腰；左蓝十字发夹，右黑金条纹大蝴蝶结；"
            "黑高立领短上衣贴合腰线，金镂空黑宝石胸针，两条长蓝编织绳垂至腰；"
            "白色短裙收腰，裙长大腿中上，右侧蓝侧幅金绣，黑交叉绑带腰饰；"
            "可配过膝白袜但不抢主装；不要把裙子画成拖地长礼裙。"
        ),
    },
    {
        "id": "diaochan_cat",
        ...
        "prompt": (
            "严格换装为王者荣耀貂蝉皮肤猫影幻舞："
            "深紫长卷发，猫耳发饰与细铃铛；深紫黑短舞衣贴合腰线，深V金边；"
            "肩臂半透黑纱披肩，腰侧高开叉短裙内衬暗紫荷叶边；"
            "金链腰饰与红流苏，黑金腕饰；居家随手拍，不要普通旗袍。"
        ),
    },
    {
        "id": "daqiao_crane",
        ...
        "prompt": (
            "严格换装为王者荣耀大乔皮肤白鹤梁神女："
            "浅粉长发半挽，白羽与金钗发饰；白金仙侠短襦，胸口白羽金纹，露肩广袖薄纱；"
            "高腰白裙侧高开，内层浅金衬裙；腰间金羽流苏；清冷神女感，不要现代婚纱。"
        ),
    },
    {
        "id": "haiyue_tide",
        ...
        "prompt": (
            "严格换装为王者荣耀海月："
            "浅海蓝色长波浪发，贝壳与珍珠发饰；冰蓝半透薄纱短袍贴合腰线；"
            "胸口珍珠链与水纹金绣，肩臂露肩，袖口层叠水纱；"
            "短裙摆侧开见内层白纱；水母/潮汐配色，居家自拍，不要潜水服。"
        ),
    },
    {
        "id": "goya_hunt",
        ...
        "prompt": (
            "严格换装为王者荣耀戈娅："
            "深棕长发高马尾，羽毛与骨饰发绳；棕绿短猎装抹胸，腰腹束带，肩臂皮革护肩；"
            "超短裙摆侧开，内层深色安全裤；长靴感护腿可裁到膝上；"
            "颈间牙饰与多层细链；荒野女猎手，不要军装大衣。"
        ),
    },
    {
        "id": "jinxi_court",
        ...
        "prompt": (
            "严格换装为鸣潮今汐，对镜全身："
            "浅粉白长发高盘髻带流苏金饰与细龙角点缀；白金短襦贴合腰线，胸口金鳞纹，露肩；"
            "外层半透白纱广袖披在臂弯，腰金带长飘带；短裙侧高开，内层浅金衬裙；"
            "站姿或微侧身对镜，裙衩自然带出腿部线条；不要常服西装，不要把短襦画成长袍。"
        ),
    },
    {
        "id": "changli_flame",
        ...
        "prompt": (
            "严格换装为鸣潮长离："
            "浅粉长直发及腰，额前细金链；朱红与浅金羽纹短舞衣，深V金边，贴合腰线；"
            "肩臂半透红纱，裙摆高开叉见内层金红衬裙；"
            "腰间朱带长飘，腕上金环；焰色仙侠，不要现代大衣。"
        ),
    },
    {
        "id": "cantarella_violet",
        "title": "坎特蕾拉·紫海",
        "prompt": (
            "严格换装为鸣潮坎特蕾拉："
            "浅紫长卷发，珍珠与贝母发饰；深紫丝绒低胸短礼服，腰线收紧；"
            "外层半透紫纱披肩，裙摆高开；颈间珍珠多层链；"
            "手套可半透至肘；海都贵妇感，不要护士装。"
        ),
    },
    {
        ...
        "prompt": (
            "严格换装为鸣潮珂莱塔："
            "银白短波浪发，冰蓝头冠；白蓝短礼裙，胸口冰晶纹，露肩；"
            "半透白纱层叠短裙，侧开见内层冰蓝衬；银细链腰饰；"
            "白丝可到膝上但不抢主装；冰冕贵族感，不要羽绒服。"
        ),
    },
    {
        "id": "yor_thorn",
        ...
        "prompt": (
            "严格换装为约尔·福杰战斗装："
            "黑长直发微卷，金色玫瑰耳饰；黑色高开叉修身长裙，胸口金玫瑰扣；"
            "肩臂露肤，外层黑纱披肩；腰金带；红瞳感妆容只作氛围不要改脸；"
            "荆棘公主，不要毛衣围裙家居服。"
        ),
    },
    {
        ...
        "prompt": (
            "严格换装为艾斯德斯军装短裙版："
            "冰蓝长发高马尾；深蓝军装短上衣金扣，深V内衬，腰封收紧；"
            "超短裙摆配深蓝长披风内衬白皮草；长手套过肘；"
            "颈间金饰；冰将军气场，不要全包厚重大衣盖住腿线。"
        ),
    },
]
    ...
    def _build_leg_focus_action(
        ...
        *,
        ...
        pose_variants = {
            ...
            "kneel_crop": [
                (
                    "跪坐大腿特写：双膝并拢跪坐、臀坐脚跟，大腿内侧紧贴；"
                    "镜头贴近大腿俯拍，只露裙摆到膝部，小腿远端和双脚裁出画外；"
                    "突出并拢的大腿曲线与膝部，髋膝连续，不要硬拗。"
                ),
            ],
            "side_lie": [
                (
            ...
            "reclined_knees_crop": [
                (
                    ...
                    "第一人称从腰腹附近向下近距离俯拍；竖幅画面只露少量腰腹/裙摆、大腿与膝部，"
                    "小腿向画面远端自然延伸后出画，脚踝和双脚完整裁出画外；"
                    "髋膝连接连续，屈膝角度日常可维持。"
                ),
                (
                    "座椅后仰拍大腿：臀部稳定坐好，背部轻靠椅背，双腿屈膝抬起、自然并拢或留很窄间隙；"
                    "手机贴近腰腹向下俯拍，构图集中在裙摆、大腿和膝盖，双脚完整裁出画外，"
                    "两侧髋膝连接连续，左右腿边界清楚。"
                ),
            ],
        }
        ...
        hard_crop = (
            ...
            "不露脸：脸部、头发、五官完整裁出画外，禁止膝盖顶脸或把脸夹在双膝之间。"
        )
        anatomy_rules = (
        ...
        if legwear == "光腿神器":
            legwear_rule = "本次腿部穿搭：光腿神器。大腿自然肤色带轻微纹理，主要看腿形；不要陶瓷磨皮；不展示脚部。"
        else:
        ...
        base = (
            ...
            "不露脸：脸部/五官/头发完整裁出画外；不要大头与膝盖挤在同一画面。"
