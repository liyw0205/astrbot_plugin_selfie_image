...
LEGWEAR_PROMPTS = {
    ...
    "白丝": (
        "本次腿部穿搭：白丝。"
        "纯白不透的中筒丝袜，遮住肤色，主要看腿形轮廓；袜口在大腿中段，完整包住小腿与脚部，大腿根以上露肤；"
        "袜口自然贴合并带浅压痕；不要超薄透视、不要透到能清楚看见皮肤纹理，不要涂色感或连裤全包。"
    ),
    "黑丝": (
        "本次腿部穿搭：黑丝。"
        "纯黑不透的中筒丝袜，遮住肤色，主要看腿形轮廓；袜口在大腿中段，完整包住小腿与脚部，大腿根以上露肤；"
        "袜口自然贴合并带浅压痕；不要超薄透视、不要透到能清楚看见皮肤纹理，不要涂色感或连裤全包。"
    ),
}
