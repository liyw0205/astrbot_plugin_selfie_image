        ...
        *,
        ...
        pose_variants = {
            ...
            "side_lie": [
                (
                    ...
                    "上面腿的膝盖朝前不要翻到背后；镜头沿腿近景，从腰下到赤足；"
                    "手可自然放在身侧，不要伸向脚面。"
                ),
            ],
            "hug_knee": [
                (
                    "抱膝坐：坐在床或地毯上，双膝收近身前但不要压扁胸腔，双手从肩肘连续伸出环抱膝盖，"
            ...
            "cross_leg": [
                (
                    ...
                    "小腿外侧与赤足脚踝清楚；姿势放松日常，不要僵硬拧踝；第一人称略俯视下半身；手远离脚面。"
                ),
            ],
            "stand_topdown": [
                (
                    "站立俯视拍腿：站在居家地面，镜头压在腰下到膝下，只拍大腿下半、小腿与赤足，"
                    "不要全身立绘；双脚自然平行站立或一只脚轻微点地，脚尖朝前，不要外八或反折。"
                ),
            ],
            "windowsill": [
                (
                    "窗台稳坐拍腿：臀稳坐窗台或矮柜，重心落在坐骨，一脚轻踩台沿、一脚自然垂下，"
                    "垂下的脚脚踝正位、脚趾朝前；不要悬空拧腿或整条腿翻折；镜头从略高处拍下半身到脚；手可扶台沿，不碰脚。"
                ),
            ],
            "kneel_up": [
                (
                    "跪立拍腿：双膝跪地、上身略前倾但仍以腿部为主，镜头贴腿面俯视膝到赤足；"
                    "双膝间距自然，小腿平行贴地，不要左右膝交叉或硬拗；手可轻放大腿，不整理腿部穿搭。"
                ),
            ],
            "reclined_knees_crop": [
                (
        ...
        if feet_cropped:
            hard_crop = (
                ...
                "小腿只在远端少量出现后离开画面，脚踝和双脚完整裁出画外；不要补画脚尖、脚底或鞋。"
            )
            anatomy_rules = (
                "单人限定：画面里只有主角一人。只保留两条自然大腿和两个膝部，左右各一，边界清楚。"
                "髋部、大腿与膝盖连接连续，双膝弯曲方向一致且符合坐姿；不要交叉融合、反关节或多出第三条腿。"
                "大腿体积自然，膝盖结构清楚；近距离俯视保留近大远小。手部尽量不入镜。"
            )
        else:
            hard_crop = (
        ...
        if feet_cropped:
            if legwear == "光腿神器":
                legwear_rule = "本次腿部穿搭：光腿神器。大腿呈自然通透的干净裸腿效果，肤色均匀细腻，不要厚重打底感。"
            else:
                color = "纯白" if legwear == "白丝" else "纯黑"
                legwear_rule = (
                    f"本次腿部穿搭：{legwear}。使用{color}轻薄半透明的左右分离大腿袜；"
                    "袜口在大腿上段，贴合大腿并有自然压痕，可带柔软褶边或蝴蝶结；"
                    "明确不是连裤袜、打底裤或一体全包袜。袜身随小腿延伸到画外，画面不展示脚部。"
                )
        base = (
            "看看腿。"
            ...
            "腿部质感要求：干净、细腻、自然，结构完整。"
            "腿部比例自然：大腿不要异常粗圆，膝有正常骨感，小腿与大腿协调；第一人称俯视要有近大远小。"
            + ("双脚完整裁出画外：不要显示脚踝、脚尖、脚底、鞋子或任何脚部细节。" if feet_cropped else "赤足无鞋：不要鞋子、拖鞋、皮鞋或任何鞋类。")
            + ("" if feet_cropped else "若本次是光腿神器：脚趾五个分开自然、脚型正常，不要脚趾黏连融合。")
            + ("" if feet_cropped else "若本次是白丝/黑丝：丝袜必须包住整只脚到脚趾，不要露趾露跟或半截袜。")
            + f"{legwear_rule}"
            + f"{anatomy_rules}"
            + f"{hard_crop}"
        )
