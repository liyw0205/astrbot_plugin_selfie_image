...
COS_LOOK_SETS: List[Dict[str, str]] = [
    ...
    },
    {
        ...
        "prompt": (
            "严格换装为王者荣耀公孙离皮肤墨染江湖："
            "水墨江湖舞姬装，主色墨黑、宣纸白与淡灰，带墨点泼墨纹理；"
            "黑白分层广袖舞衣，外层半透墨色薄纱，内层白绸；"
            "腰间墨色束带与流苏，袖口与裙摆有水墨晕染与飞白笔触；"
            "深色长发或墨黑假发，可带白梅/墨竹小发饰；"
            "气质清冷侠气，不要青绿金绣那套默认皮，不要铠甲，日常得体。"
        ),
    },
    {
        "id": "elysia_pink",
    ...
    },
    {
        ...
        "prompt": (
            "严格换装为冰蓝仙侠广袖袍："
            "外层极透冰蓝广袖薄纱长袍，蓝金花鸟刺绣，袖口宽大垂地；"
            "内层米白长裙与蓝色镶边；蓝色丝绦腰带+双金圆牌+长蓝飘带；"
            "深色长发半挽，小白花发饰；空灵飘逸，不要现代常服，居家跪坐或站姿，日常得体。"
        ),
    },
    {
        "id": "sora_white",
    ...
    },
    {
        ...
        "title": "洛琪希·奶油居家",
        "prompt": (
            "严格换装为洛琪希居家休闲两件套（不是蓝袍法师装）："
            "米白/奶油色无袖方领上衣，柔软微皱棉质，领口细荷叶边，"
            "胸下松紧抽褶与垂坠褶皱，宽松灯笼剪裁；"
            "左胸白色缎带蝴蝶结，长飘带自然下垂；"
            "同色米白宽松居家短裤，松紧腰，长度大腿中上；"
            "浅薰衣草紫/淡蓝紫长发粗双麻花辫从肩前垂落，辫尾金发绳可带细白珠；"
            "禁止蓝色旅行法师外套、禁止宽檐帽、禁止法杖；居家跪坐地毯，日常得体。"
        ),
    },
    {
        "id": "hanfu_peach",
    ...
    },
    {
        ...
        "prompt": (
            ...
            "黑高立领白十字纹，金镂空黑宝石椭圆胸针，两条长蓝编织绳bolo垂至腰；"
            "白长袖连衣裙主体，浅竖条与蓝点缀，黑交叉绑带腰饰，右侧蓝侧幅金绣，银细链；"
            "白黑金蓝配色，软萌祭司感，日常得体。"
        ),
    },
    {
    ...
    },
    {
        ...
        "prompt": (
            "严格换装为鸣潮今汐："
            "浅粉白长发高盘髻带流苏金饰；白金宫廷短襦，胸口金鳞纹，露肩；"
            "外层半透白纱广袖，腰金带长飘带；短裙侧高开，内层浅金衬；"
            "龙角/金鳞小头饰可点缀；端丽宫廷，不要常服西装。"
        ),
    },
    {
        "id": "changli_flame",
    ...
    def _build_cos_look_action(
        ...
        *,
        ...
        base = (
            ...
            "第一人称自拍或居家随手拍；脸型五官必须保持形象参考，不要换成别人的脸；"
