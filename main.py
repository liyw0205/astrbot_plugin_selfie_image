...
# Curated from public Douyin-indexed COS references: keep garment silhouettes
# concrete and avoid large game-skin pools whose details are easy to hallucinate.
COS_LOOK_SETS: List[Dict[str, str]] = [
    ...
    {"id": "lusha_white_gold", "title": "露莎公主·白金礼服", "prompt": "严格换装为《死馆2》的露莎公主公开立绘版本，锁定黑皮公主礼服形象，不要把角色名替换成其他作品的露莎：深色皮肤成年女性，依据参考形象保持对应发色、发型和角色配饰；贴身礼服式上身，肩部裸露或无袖，胸腰结构紧身收束并有清晰装饰线；腰部是结构化公主腰线，不是松垮长袍；长而有垂坠感的拖地裙，前中部保留明显纵向开衩，露出内层裙片，礼服整体有舞台公主感。保持参考图中的准确配色和饰品，不要自行添加皇冠；室内柔光对镜全身。不要《最终幻想VII》LOVELESS露莎/爱丽丝舞台礼服、不要《小花仙》仙女露莎、不要迪士尼公主裙、不要白雪公主蓝黄裙、不要普通婚纱、不要洛丽塔、不要精灵翅膀、不要泛化白色蓬蓬裙。"},
    {"id": "elsa_ice_cape", "title": "艾莎·冰蓝披风礼服", "prompt": "严格换装为《冰雪奇缘》2013年《Let It Go》经典冰雪礼服，不是加冕礼服或第二部服装：白金金色长发，侧分，松散侧麻花辫垂在肩前，不戴皇冠；冰蓝色贴身无袖礼服上身，心形/甜心领口，胸腹有银色雪花与冰晶亮片纹样；腰线贴身清楚，不要宽腰封和蝴蝶结；冰蓝色拖地长裙，裙面有透明闪亮薄纱覆盖层，银色雪花细节；从肩部或肩背连接一条半透明冰蓝色闪粉长披风/拖尾，披风必须是完整服装结构而不是背景特效；露出时配冰蓝或银色尖头礼服鞋。主色只用冰蓝、浅青蓝、银、白；室内柔光对镜全身。不要黑绿高领加冕礼服、不要皇冠、不要《冰雪奇缘2》深蓝紫色服装、不要紫色斗篷、不要不透明长袖、不要普通蓝色舞会裙、不要黑靴和白色过膝袜。"},
    {"id": "miku_formula_blue", "title": "初音未来·蓝白公式服", "prompt": "严格换装为初音未来原始 KEI/CV01 经典 VOCALOID 公式服，不是 Snow Miku、Project Sekai 或演唱会礼服：青绿色超长高位双马尾，长度超过腰部，黑色耳机；白色无袖高领短上衣，黑色领口与黑色装饰，胸前青绿色细领带，露出一小段腰腹；左上臂有红色01标记；双臂佩戴独立式黑色长臂套而不是白色长袖，臂套有青绿色条纹；黑色宽腰带/腰封带青绿色几何装饰；黑色短款百褶裙，裙褶和侧边有青绿色镶边；黑色过膝袜，黑色及膝高筒靴带灰色或青绿色细节。黑、白、青绿为主体，服装必须是分体短上衣加短百褶裙的未来感结构；室内柔光对镜全身。不要普通JK水手服、不要连衣裙、不要长裙、不要传统长袖、不要 Snow Miku 冬装、不要 Project Sekai 其他服装、不要黑岩射手黑发黑衣。"},
    {"id": "sakura_pink_magic", "title": "木之本樱·粉白魔法裙", "prompt": "严格换装为《魔卡少女樱/Cardcaptor Sakura》初期经典粉白捕获服，不是友枝中学校服，也不是任意一套后期战斗服：棕色齐肩外翘短发，两侧红色发饰；配套粉白魔法帽，帽上有红色大蝴蝶结和小翅膀/羽饰；白色贴身上身带粉色滚边，胸前 oversized 红粉色大蝴蝶结；白色短泡泡袖，袖口粉色镶边；粉色腰封/腰带，背后大蝴蝶结；粉白分层短蓬裙，裙摆有多层粉色饰边，下面露出白色衬裙/灯笼短裤，不要长裙；小型翼状服装装饰；白色不透明过膝袜/连裤袜，粉色圆头玛丽珍系带鞋。粉、白、红粉三色分层清晰，室内柔光对镜全身。不要友枝中学校服、不要普通粉色公主长裙、不要婚纱、不要黑色服装、不要现代洛丽塔、不要透明巨大翅膀、不要巫女服。"},
    {"id": "shinobu_butterfly", "title": "蝴蝶忍·蝶纹羽织", "prompt": "严格换装为《鬼灭之刃》蝴蝶忍标准鬼杀队制服，不是蝴蝶主题礼服：黑发短发，发梢紫色渐变，白色蝴蝶翅形发夹带紫粉边缘；深紫色贴身立领、长袖鬼杀队制服，前襟纽扣结构；外披白色宽袖羽织，羽织下摆和袖口是清晰的蝴蝶翅膀锯齿轮廓，白色向紫、粉、蓝紫渐变，带蝶翼纹样；白色腰带；下半身明确为紫色制服长裤/窄腿裤，不要裙子；白色脚绊包裹小腿，白色足袋，深色传统草履/木屐。服装结构必须先显示羽织、立领制服、裤装和足袋木屐，武器放在侧边不遮挡衣服；室内柔光对镜全身。不要蝴蝶翅膀特效、不要透明翅膀、不要紫色水手服、不要护士服、不要女仆装、不要连衣裙、不要百褶裙、不要高跟鞋。"},
    {"id": "mitsuri_love", "title": "甘露寺蜜璃·恋柱羽织", "prompt": "严格换装为《鬼灭之刃》甘露寺蜜璃标准恋柱造型，不是普通粉色和服：极长樱粉色头发，中段至发尾渐变黄绿色，编成三条粗麻花辫，蓬松碎刘海；粉色调改造鬼杀队制服，白色立领，胸前保持制服式开放领口和纽扣结构；纯白色短羽织敞开穿着，羽织无蝴蝶翅纹、无复杂图案；白色腰带；下装是深海军蓝短款百褶裙，裙长在大腿上部；腿部先穿深蓝色过膝袜，再叠穿带黄绿色竖条纹的长袜套，形成深蓝底加黄绿纵条纹的双层结构；白色日式草履，粉色鞋带。粉、纯白、深海军蓝、黄绿色四组颜色清楚，室内柔光对镜全身；心形刀镡可在侧边，不要遮挡服装。不要蝴蝶纹羽织、不要标准长裤鬼杀队制服、不要普通粉色连衣裙、不要黑丝袜、不要高跟鞋、不要白色丝袜、不要女仆装。"},
    {"id": "tracen_academy", "title": "赛马娘·特雷森学院制服", "prompt": "严格换装为《赛马娘 Pretty Derby》特雷森学院夏季制服，固定夏季两件式制服版本，不是胜负服：棕色中长发，保留特别周风格的棕色马耳、自然马尾和马尾；紫色学院制服短袖上衣与紫色百褶短裙明确分体，白色衬衫/领部层次，胸前学院蝴蝶结带马蹄铁图案；裙后保留马尾和马尾穿出的开口；普通学院腰线，不要礼服束腰；深色学生袜和深色学院鞋。整体是紫色、白色的轻薄夏季校园制服，室内柔光对镜全身。不要特别周红白蓝胜负服、不要舞台偶像蓬蓬裙、不要运动服、不要赛跑鞋、不要普通水手服、不要冬季长袖大衣、不要赛场背景、不要把马耳画成猫耳。"},
    {"id": "yao_cinnamoroll", "title": "瑶·大耳狗之梦", "prompt": "严格换装为《王者荣耀》瑶限定皮肤「大耳狗之梦」官方联动造型，不是瑶的其他皮肤：蓝白渐变编发，辫尾系蓝色缎带蝴蝶结；头部同时保留白色毛绒大耳狗耳朵头饰和瑶标志性的水晶气泡鹿角，不能替换成猫耳或普通鹿角；云白与天蓝色短款梦幻蓬蓬裙，白色上身配蓝色滚边和胸前大蝴蝶结，腰间蓝色缎带与云朵装饰；裙子有多层蛋糕裙结构，外层半透明水蓝色云纹罩纱，裙摆装饰云朵、泡泡和彩虹色小泡泡，装饰必须在服装裙摆上而不是只放背景；可带云朵草莓蛋糕法杖但不得遮挡衣服。柔软清爽的白、天蓝、半透明水蓝配色，室内柔光对镜全身。不要瑶原皮古风服、不要敦煌服、不要紫黑酷洛米风、不要普通水手服、不要普通白裙、不要把云朵和彩虹只做成背景特效、不要复杂铠甲。"},
    {"id": "barbara_idol", "title": "芭芭拉·蓝白祈礼服", "prompt": "严格换装为《原神》芭芭拉默认服装「纯真期待」/西风教会祈礼牧师偶像服，不是夏日皮肤「闪耀协奏」：浅金色双马尾，蓝色发饰；蓝白色短款连衣裙，肩部露肩，胸前白色牧师式前襟与蓝色领结，蓝色腰线收束；使用独立式分离短袖/袖套，肩膀与袖子之间保留裸露间隔，不要一体长袖；裙摆是轻量蓝白分层褶边短裙，带白色装饰层和蓝色裙边，不要厚重礼服；白色不透明连裤袜，蓝色或深色短靴。主色海蓝、白色，少量金色细节，室内柔光对镜全身。不要泳装、不要夏日海滩裙、不要传统修女长袍、不要高领长袖教会服、不要普通水手服、不要黑丝袜、不要长筒靴、不要高跟舞台鞋、不要法杖和水元素特效遮挡服装。"},
]
